...
from digest import DailyDigestEmail
from daily_schedular import DailySchedular
import json
class DailyDigestGUI:
    ...
    def __init__(self, root):
        ...
        self.__scheduler = DailySchedular()
    ...
    """
    def __save_config(self, file_path='config.json'):
    ...
    """
    def __load_config(self, file_path='config.json'):
